...
export const directorsApi = {
  ...
  getEntitiesForDirector: (directorId: string) => apiMethods.get<{ data: any[] }>(`/directors/${directorId}/entities`),
  getActiveEntitiesForDirector: (directorId: string) => apiMethods.get<{ data: any[] }>(`/directors/${directorId}/entities/active`),
  getEntitiesCountForDirector: (directorId: string) => apiMethods.get<{ data: number }>(`/directors/${directorId}/entities/count`),
